...
class ArgsBase():
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--default_root_dir',
                    type=str,
                    default='.',
                    help='Default root directory for checkpoints')
...
if __name__ == '__main__':
    ...
    # 'mps'로 설정된 경우 PyTorch Lightning에서 MPS 사용
    ...
    trainer = L.Trainer(max_epochs=args.max_epochs,
                        ...
                        devices=args.num_gpus if args.accelerator != 'mps' else 1,  # MPS의 경우 장치 수 1로 설정
